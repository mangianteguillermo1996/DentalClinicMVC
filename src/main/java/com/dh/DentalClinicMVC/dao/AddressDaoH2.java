...
public class AddressDaoH2 implements IDao<Address> {
    ...
    private static final String SQL_UPDATE = "UPDATE ADDRESSES SET STREET=?, SET NUMBER=?, SET LOCATION=?, SET PROVINCE=? WHERE ID=?";

    private static final String SQL_DELETE = "DELETE FROM ADDRESSES WHERE ID = ?";

    private static final String SQL_FINDALL = "SELECT * FROM ADDRESSES";
